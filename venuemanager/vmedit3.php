...
$readquery = "SELECT 2020_event.eid, 2020_event.etitle, 2020_event.edes, 2020_event.edate, 2020_event.etime, 2020_event.eimage,
              2020_eventcat.etname, 2020_venuemanager.vmname, 2020_venuecat.vname, 2020_venuecat.vid FROM 2020_event
                            ...
                            <div class="w-75">
                                <form enctype='multipart/form-data' action='vmeditprocess.php' method='POST'>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name='Newcatvenue' required>
                                            <?php
