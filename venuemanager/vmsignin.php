                    ...
                    <div class="d-flex justify-content-center">
                        <div class="w-75">
                            <form action='vmsigninprocess.php' method='POST'>
                                ...
                                <div class="d-flex justify-content-center"><input class="btn btn-info w-50" type="submit" value="Login" name="requestvmlogin"></div>
                                <div class="text-center pt-3"><a href="vmchangepass.php"><u class="text-info">Forget password</u></a></div>
                            </form>
                        </div>
                    </div>
                </div>
