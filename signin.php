                ...
                <div id="signInForm">
                    <div>
                        <div class="d-flex justify-content-center align-items-center ">
                            <div id="signInFormPaper" class="m-1">
                                    ...
                                    <div class="w-75">
                                        <form action='signinprocess.php' method='POST'>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="signInPassword" class="form-control" type="password" name="mpass" placeholder="Enter password" required />
                                                <div class="custom-control custom-checkbox my-1 mr-sm-2">
                                                    <input type="checkbox" class="custom-control-input" id="customControlInline" onclick="togglePass()">
