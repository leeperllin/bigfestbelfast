...
<body>
    <div id="adminBgVideoDiv">
        <div id="adminBgVideoOverlay" class="overlay"></div>
        <video id="adminBgVideo" playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop">
        ...
        <div id="adminBgVideoContainer" class="container h-100">
            <div id="adminSignInForm">
                <div>
                    <div class="d-flex justify-content-center align-items-center h-100">
                        <div id="adminSignInFormPaper">
                            <div class="d-flex justify-content-center text-center pt-3">
                                <h1 class="text-primary pb-4">Admin Login</h1>
                            </div>
                            <div class="d-flex justify-content-center">
                                <div class="w-75">
                                    <form action='adsigninprocess.php' method='POST'>
                                        <div class="form-group">
                                            <label class="text-primary"><svg class="bi bi-people-circle" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M13.468 12.37C12.758 11.226 11.195 10 8 10s-4.757 1.225-5.468 2.37A6.987 6.987 0 008 15a6.987 6.987 0 005.468-2.63z" />
                                                    <path fill-rule="evenodd" d="M8 9a3 3 0 100-6 3 3 0 000 6z" clip-rule="evenodd" />
                                                    <path fill-rule="evenodd" d="M8 1a7 7 0 100 14A7 7 0 008 1zM0 8a8 8 0 1116 0A8 8 0 010 8z" clip-rule="evenodd" />
                                                </svg> ID Name:</label>
                                            <input class="form-control" type="text" name="aduser" placeholder="Enter ID Name" required />
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="password" name="adpassword" placeholder="Enter password" required />
                                        </div>
                                        <div class="d-flex justify-content-center">
                                            <input class="btn btn-primary w-50" type="submit" value="Login" name="requestadlogin">
                                        </div>
                                    </form>
                                </div>
                            </div>
